  ...
  return (
    <article className="rounded-[28px] border border-[#ddd3f0] bg-white p-6 shadow-sm">
      ...
      <p className="mt-2 text-sm text-[#5f5673]">
        Connect Google Calendar so CAP can later mirror ministry meeting reminders directly onto your personal calendar.
      </p>
      ...
      <div className="mt-4 rounded-2xl border border-[#e6def4] bg-[#fbf9fe] p-4">
        ...
        <p className="mt-2 text-sm text-[#5f5673]">
          {isConnected
            ? `Connected on ${connectedAt}. CAP has stored your Google Calendar refresh token for later event sync features.`
            : 'CAP reminders already work without calendar sync. Connect here to enable Google Calendar token storage for future direct event mirroring.'}
        </p>
      </div>
