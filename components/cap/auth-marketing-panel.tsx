...
const highlights = [
  'Weekly record capture for ministry accountability',
  'Invite-only onboarding through department-specific access links',
  ...
  return (
    <section className="rounded-[36px] border border-[#d8caef] bg-[linear-gradient(135deg,#341765_0%,#4B248C_58%,#5d33aa_100%)] p-8 text-white shadow-[0_28px_90px_rgba(75,36,140,0.26)] lg:p-12">
      ...
      <h1 className="mt-8 max-w-2xl text-5xl font-semibold leading-tight">
        A calmer way to collect records, onboarding, and ministry follow-through.
      </h1>
      <p className="mt-6 max-w-2xl text-base text-[#f2ebff]">
        Christhood Accountability Platform helps every department know what to do next, whether someone is signing in
        for the first time, submitting this week&apos;s record, or reviewing ministry trends.
      </p>
