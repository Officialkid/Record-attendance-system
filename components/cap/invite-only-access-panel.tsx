  ...
  return (
    <div className="w-full space-y-5 rounded-[28px] border border-[#ddd3f0] bg-white p-8 shadow-[0_24px_80px_rgba(75,36,140,0.10)]">
      <div>
        ...
        <h2 className="mt-2 text-3xl font-semibold text-[#241c33]">CIOM Portal is opened by department invite link</h2>
        <p className="mt-2 text-sm text-[#5f5673]">
          This ministry portal is not a public signup system. A department admin creates a link for the exact team,
          then members sign in from that link and CIOM Portal places them straight into the right department workflow.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        >
          <span>Open CIOM Portal login</span>
